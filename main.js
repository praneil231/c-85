...
function up(){
    if (player_y>0){
        ...
        console.log("blocke image heihgt="+block_image_heigth);
...
function left(){
    if (player_x>0){
        ...
        console.log("blocke image width="+block_image_width);
        console.log("when up arrow key is pressed ,x="+player_x+"x is ="+player_y);
        canvas.remove(player_object);
        player_update();
    }
}
